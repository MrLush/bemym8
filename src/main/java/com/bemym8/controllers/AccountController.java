...
public class AccountController {
    ...
    @PostMapping("/account")
    public String accountPageSubmit(@RequestParam String username, @RequestParam String firstName, @RequestParam String lastName, @RequestParam String body, Model model){
        try{
